...
public class UnosPrivatnogKorisnikaController {
	...
	public void spremiPrivatnogKorisnika() {
		...
		/*if(grad.isBlank()) {
			imaGresaka = true;
			greske.append("Grad korisnika nije upisan!\n");
		}*/
		...
		if(imaGresaka) {
			...
			final Tooltip imeToolTip = new Tooltip();
	    	imeToolTip.setText("Ime mora biti uneseno!");
	    	final Tooltip prezimeToolTip = new Tooltip();
	    	prezimeToolTip.setText("Prezime mora biti uneseno!");
	    	final Tooltip telefonToolTip = new Tooltip();
	    	telefonToolTip.setText("Telefon mora biti unesen!");
	    	final Tooltip emailToolTip = new Tooltip();
	    	emailToolTip.setText("e-mail mora biti unesen!");
			
			imeTextField.setTooltip(imeToolTip);
			prezimeTextField.setTooltip(prezimeToolTip);
			telefonTextField.setTooltip(telefonToolTip);
			...
			alert.showAndWait();
			PrivatniKorisnik noviPrivatniKorisnik = new PrivatniKorisnik(email,telefon,ime,prezime,grad);
